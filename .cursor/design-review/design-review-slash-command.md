...
OBJECTIVE:
Use the design-review agent to comprehensively review the complete diff above, and reply with the design review report. Your final reply must contain the markdown report and nothing else.

Follow and implement the design principles and style guide located in the .cursor/context/design-principles.md and .cursor/context/style-guide.md docs.
